...
class Test_parkingplace_class:
    ...
    def test_parameters_are_used_in_constructur_correct_id(self):
    ...
    def test_parameters_are_used_in_constructur_correct_name(self):
        pplace = parkingplace("0001", "TestPlass", "Adresseveien1", "1234", "1", "50", "NULL", "Har lader")
        expected = "TestPlass"
        actual = pplace.name
        assert actual == expected
    ...
    def test_parameters_are_used_in_constructur_correct_address(self):
        pplace = parkingplace("0001", "TestPlass", "Adresseveien1", "1234", "1", "50", "NULL", "Har lader")
    ...
    def test_parameters_are_used_in_constructur_correct_zipcode(self):
        pplace = parkingplace("0001", "TestPlass", "Adresseveien1", "1234", "1", "50", "NULL", "Har lader")
        expected = "1234"
    ...
    def test_parameters_are_used_in_constructur_correct_number_of_spaces(self):
        pplace = parkingplace("0001", "TestPlass", "Adresseveien1", "1234", "1", "50", "NULL", "Har lader")
        expected = "1"
